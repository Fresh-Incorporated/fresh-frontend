  ...
  <div class="w-full relative">
    ...
    <div class="relative">
      <div class="animation-opacity absolute w-4 h-4 top-32 left-64">
        ...
        <div class="animation-opacity absolute -left-2 top-[7.5rem] w-4 h-4 flex justify-center items-center aspect-square">
        ...
        <div class="animation-opacity absolute top-4 w-px h-24 bg-gradient-to-b from-white/0 dark:via-white via-neutral-400 to-white/0"></div>
        <div class="animation-opacity absolute left-4 h-px w-64 bg-gradient-to-r dark:from-white from-neutral-400"></div>
        <div class="animation-opacity absolute left-4 top-32 h-px w-96 bg-gradient-to-r dark:from-white from-neutral-400"></div>
        <div class="animation-opacity absolute -left-20 top-32 h-px w-16 bg-gradient-to-l dark:from-white from-neutral-400"></div>
        <div class="animation-opacity absolute top-36 w-px h-16 bg-gradient-to-b dark:from-white from-neutral-400"></div>
        <div class="animation-opacity absolute -top-20 w-px h-16 bg-gradient-to-t dark:from-white from-neutral-400"></div>
        <div class="animation-opacity absolute -left-20 h-px w-16 bg-gradient-to-l dark:from-white from-neutral-400"></div>
      </div>
    </div>
    <div class="min-h-96 flex items-center md:px-72">
...
<!--          </div>-->
<!--        </div>-->
        <p class="text-black dark:text-white opacity-80">
