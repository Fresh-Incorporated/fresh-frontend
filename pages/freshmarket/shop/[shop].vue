...
<div class="w-full">
  ...
  <transition name="loaded">
    <div v-if="!loaded" class="w-full top-18 flex justify-center absolute">
      <Skeleton class="md:w-11/12 h-24" />
      <Skeleton class="md:w-11/12 h-12 absolute top-26" />
      <div class="grid w-full md:w-11/12 gap-2 md:gap-4 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 absolute top-40">
    ...
    <div v-else class="w-full h-full overflow-auto my-4 md:w-11/12 mx-auto space-y-2">
