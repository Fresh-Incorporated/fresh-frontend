...
<template>
  <div class="bg-neutral-50 dark:bg-neutral-900 rounded-xl shadow-lg border bg-neutral-50 dark:border-neutral-800 h-64 flex flex-col justify-center items-center">
