...
const groups = [
  ...
  },
  {
    name: "Секретарь",
    icon: "lucide:settings",
    to: "/cabinet/freshmarket/work/secretary/verify/shop",
    fm_worker_min: 3,
    links: [
      {
...
<template>
  <ShSidebarGroup v-if="!userLoading && user?.fm_worker > 0">
    <ShSidebarGroupLabel>FreshMarket Работа</ShSidebarGroupLabel>
    <ShSidebarMenu>
      <ShCollapsible
